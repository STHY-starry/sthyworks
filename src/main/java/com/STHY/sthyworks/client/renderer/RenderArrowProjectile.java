...
public class RenderArrowProjectile extends Render {

    private final ResourceLocation texture;

    public RenderArrowProjectile() {
        this.texture = new ResourceLocation("sthyworks", "textures/models/entity/arrowProjectile.png");
    }
