...
public class RenderPathogenesisProjectile extends Render {

    private final ResourceLocation texture;

    public RenderPathogenesisProjectile() {
        this.texture = new ResourceLocation("sthyworks", "textures/models/entity/pathogenesisProjectile.png");
    }
