...
public class WorldGeneratorGuguBlock extends WorldGenerator {
    ...
    public WorldGeneratorGuguBlock(Block block, int minHeight, int maxHeight,
                                   int blocksPerChunk, int maxClusterSize) {
    ...
    public boolean generate(World world, Random rand, int x, int y, int z) {
        for (int i = 0; i < blocksPerChunk; i++){
            ...
            if (world.getBlock(randX, randY, randZ).isReplaceableOreGen(world, randX, randY, randZ, Blocks.stone)) {
                ...
                for (int j = 0; j < clusterSize; ++j) {
                    ...
                    if (world.getBlock(targetX, targetY, targetZ).isReplaceableOreGen(world, targetX, targetY, targetZ, Blocks.stone)) {
